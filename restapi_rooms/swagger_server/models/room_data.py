...
class RoomData(Model):
    ...
    """
    def __init__(self, room: str=None, temperature: List[TemperatureReading]=None, airquality: List[AirQualityReading]=None, light: List[LightReading]=None, humidity: List[HumidityReading]=None):  # noqa: E501
